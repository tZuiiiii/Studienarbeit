...
Ein negativer Wert bedeutet, dass die rPPG-Messung unterhalb des Watch-Wertes liegt. Ein positiver Wert bedeutet, dass die rPPG-Messung oberhalb des Watch-Wertes liegt. Zusätzlich wurden die \ac{mae} also die mittlere absolute Abweichung und \ac{rmse} also die quadratische mittlere Abweichung berechnet. Der MAE beschreibt die durchschnittliche absolute Abweichung in BPM, während der RMSE größere Einzelabweichungen stärker gewichtet.
